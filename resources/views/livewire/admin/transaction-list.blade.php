                        ...
                        <td class="px-6 py-4 text-right">
                            ...
                            <div style="display: flex; justify-content: center;">
                                    ...
                                    <div style="text-align: center; padding-top: 5px;">
                                        <button
                                            style="margin-left: 13px; background-color: #ffffff; color: white; padding: 8px 18px; border: 1px solid #ccc; border-radius: 10px; cursor: pointer; transition: background-color 0.3s ease; "
