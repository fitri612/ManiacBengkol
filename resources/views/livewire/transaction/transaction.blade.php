                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Code Invoice</th>
                                <th scope="col" class="px-4 py-3">Grand Total</th>
                                <th scope="col" class="px-4 py-3">nominal</th>
                                <th scope="col" class="px-4 py-3">transaction note</th>
                        ...
                        <tbody>
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">
                                    <a href="{{ asset('img/avataritem.png') }}" target="_blank">
                                        <img class="w-10 h-10 rounded-full" src="{{ asset('img/avataritem.png') }}"
                                            alt="avatar">
                                    </a>
                                </td>
