...
@section('content')
    ...
    <div
        class="max-w-3xl bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-6 mx-auto">
        <form>
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="file" id="image" name="image_profile" accept="image/*"
                            ...
                            value="{{ $user->image_profile }}" onchange="previewImage()">
                        <div class="text-sm text-red-600">
                            @error('image_profile')
                                {{ $message }}
                            @enderror
