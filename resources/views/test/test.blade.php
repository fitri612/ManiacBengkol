...
<div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
  ...
  <div class="max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class=" mt-3 flex items-center dark:text-white">
      ...
      <a class="text-green-600 ml-auto" href="#" wire:click.prevent="deleteSelectedItems" wire:loading.attr="disabled">
        Hapus yang dipilih
      </a>
      @endif   
    </div>
    ...
    <div wire:key="cart-item-{{ $item->id }}" class="max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:text-white">
        ...
        <div class="flex items-center col-span-1">
          <div class="custom-number-input h-10 w-32">
            <div class="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1">
              <button class="bg-gray-300 text-gray-600 hover:text-gray-700 hover:bg-gray-500 h-9 w-8 rounded-l cursor-pointer outline-none"
              wire:click="decrementQty({{ $item->id }})">
                <span class="m-auto text-2xl font-thin">−</span>
              </button>
              <span class="p-2">{{ $item->quantity }}<</span>
              <button class="bg-gray-300 text-gray-600 hover:text-gray-700 hover:bg-gray-500 h-9 w-8 rounded-r cursor-pointer"
      ...
      <div class="rounded-md p-6">
        ...
        <div class="mt-4">
          <div class="flex justify-between py-2">
            ...
            <span class="font-semibold">{{ $sub_total }}</span>
          </div>
          <div class="flex justify-between py-2">
