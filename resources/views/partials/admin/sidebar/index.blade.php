        ...
        <div
            ...
            <div class="flex pt-4">
                <a href="#">
                    ...
                    src="https://gcdnb.pbrd.co/images/4LUQpWQfxfra.png?o=1" alt="maniac Logo" />
                </a>
            </div>
            ...
            <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
                ...
                <!-- Apps -->
                <a href="{{ url('/product') }}" data-sidebar="product"
                    class="sidebar-item flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
...
sidebarItems.forEach(item => {
  item.addEventListener('click', function(event) {
    ...
    // Store the active item in session storage
    const sidebarId = this.getAttribute('data-sidebar');
    sessionStorage.setItem('activeSidebarItem', sidebarId);
  });

  // Check if there is a stored active item in session storage
  const storedActiveSidebarItem = sessionStorage.getItem('activeSidebarItem');
  if (storedActiveSidebarItem) {
    // Add "active" class to the stored active item
    if (item.getAttribute('data-sidebar') === storedActiveSidebarItem) {
