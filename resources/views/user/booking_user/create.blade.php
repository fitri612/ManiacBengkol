        ...
        <div class="p-6 space-y-6">
            <div class="sm:col-span-3">
                <div class="grid grid-cols-2 gap-2">
                    <div class="mt-2">
                        ...
                        <input type="text" name="user_name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 @error('name') is_invalid @enderror"
                         ...
                         <input type="text" name="user_id" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 @error('name') is_invalid @enderror"
                ...
                <div class="mt-2">
                    ...
                    <textarea type="text" name="note" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 @error('description') is_invalid @enderror">{{old('note')}}</textarea>
                    <div class="text-sm text-red-600">
                        @error('note')
                            {{$message}}
                        @enderror
                ...
                <div class="mt-2">
                    {{-- <div class="mt-2 ">
                        <label  class="block text-sm font-medium leading-6 text-gray-900">Beli Produk (optional)</label>
                        <div class="tambah_group relative mb-4 flex flex-wrap items-stretch">
                            ...
                            <button
                              class="add_product z-[2] inline-block rounded-r bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out bg-blue-700 hover:bg-blue-800"
                              data-te-ripple-init
                              type="button"
                              id="button-addon2">
                              tambah produk 
                ...
                <button  type="submit" class=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ">Tambah Booking</button>
